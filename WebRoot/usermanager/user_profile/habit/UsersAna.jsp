		...
		<div data-options="region:'north',height:100,title:'查询条件'">
			<div style="padding-top:5px;padding-bottom:5px;">
					...
					年 龄<select id="age" name="age"
						...
						data-options="url:'usermanager/user_profile/data/age.json',multiple:true,panelHeight:170"></select>

					
					偏好分类<select id="area" name="area"
						class="easyui-combotree" style="width:170px;"
						data-options="url:'servlet/JsonServlet?method=GetAreaList',multiple:true,panelHeight:200"></select>
					权重<input id="date" name="date"
						class="easyui-datebox" editable="false" style="width:180px;" />
					推送类别<input id="date" name="date"
						class="easyui-datebox" editable="false" style="width:180px;" />
					
					<input type="button" id="srbtn"
						class="easyui-linkbutton" icon="icon-search" value="查询" />
						<input type="button" id="srbtn"
						class="easyui-linkbutton" icon="icon-search" value="推送" />
