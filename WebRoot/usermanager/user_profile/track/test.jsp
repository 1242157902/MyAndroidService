...
<html>
  ...
  <body>
    <div id="content">
    	<div id="map_title">
    	<!-- 条件选择区 -->
	    		<lable>请输入起始时间：</lable><input type="text" id="startDate" name="date" class="easyui-datebox" editable="false" />
	    		<lable>请输入截止时间：</lable><input type="text" id="endDate" name="date" class="easyui-datebox" editable="false" />
    	...
    	<script type="text/javascript"> 
    			...
    			$('#submit').click(function(){
    				...
    				$.ajax({
    					type:"post",
    					url: "servlet/UserProfileServlet?method=SelectUserMap" ,
					    data: {startDate:startDate,endDate:endDate} ,
					    success:function(data) { 
						    if(data=="null"){
						    	alert("没有在"+date+"的定位信息");
						    }else{
						    	var obj=eval(data);
						        show_map(obj);
						    }          
