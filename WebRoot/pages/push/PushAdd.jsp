...
<html>
  ...
  <table id="addphtable"  border="1" cellpadding="1" > 
       <tr>                             
           <td colspan=2 style="width:330px;height:30px;text-align:center;" >添加推送项 </td>               
       </tr>      
       <tr>                             
    ...
    <script type="text/javascript">
      $(function(){
        ...
        var data = $('#queid').combobox('getData');
             if (data.length > 0) {
                 $('#queid').combobox('select', data[0].qid);
             } 
        }
      }); 
      }); 
	function phclose()
	{ 
	  window.parent.document.getElementById("CloseAddPushTabBtn").click();
	}
    function phsave()
	{ 
