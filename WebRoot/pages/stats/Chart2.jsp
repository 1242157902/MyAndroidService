...
<head>
    ...
    function statis_mbinfo(){  
       ...
       if(staxunit=='month'&&getDays(staregstart,staregend)>365) {
		...
		$.post("${pageContext.request.contextPath }/servlet/StServlet?method=GetChart1Data",{start:staregstart,end:staregend,xunit:staxunit,tjtj:statjtj,tjxx:""+statjxx+""},function(data,status){		    
