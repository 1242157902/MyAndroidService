...
item.domId="fyy"+_1b5.parentNode.id+""+item.id;//_1b3++;//fyyhehe
cc.push("<li>");
cc.push("<div id=\""+item.domId+"\" class=\"tree-node\">");
for(var j=0;j<_1b8-1;j++){//fyyhehe
...
if(p){
//_2db(_2bf(_2da,p));fyyhehe
}else{
//_2db(opts.selected); fyyhehe
}
function _2db(_2dc){
...
function _8d5(_8d6){//fyyhehe
var _8d7=$.data(_8d6,"combo");
var opts=_8d7.options;
if(!_8d7.panel){
_8d7.panel=$("<div id="+_8d6.id+"div class=\"combo-panel\"></div>").appendTo("body");
...
vv.push(_974[i].value);//fyyhehe
ss.push(_974[i].text);
}
}else{
var node=tree.tree("getSelected");
if(node){
vv.push(node.value);//fyyhehe
ss.push(node.text);
}
}
if((vv+"").substring(0,1)=="*") 	$(_972).combo("setValues","").combo("setText","全部");//fyyhehe
else $(_972).combo("setValues",vv).combo("setText",ss.join(opts.separator));//fyyhehe
};
